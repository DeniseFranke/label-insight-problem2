...
public class ChannelTest {
   ...
   * Reason:   Note that, at the first time step after initialization, 
   ...
   * Given:   10,  "RLRLRLRLRL"
   * Returns: {"XXXXXXXXXX",".........." }
   * Reason:   These particles are moving so fast that they all exit the chamber by time 1.
   */
   ...
   * Given:    1,  "..."
   * Returns:{ "..." }
   * Reason:   There are no particles in short channel
   */
