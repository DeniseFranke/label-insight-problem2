...
public class ParticleTest {
  ...
  /**
   * Test 0)  
   * Given:  A Particle instantiated with 2, ..L....
   * Returns: The particle's location along the channel at time t 
   * If the particle has exited the channel, it returns a null when queried. 
   */
  ...
  /**
   * Test 2)  Test Right with minimal (1) change in time
   * Given:  1, ..R....
   * 		  
   */
